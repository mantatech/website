...
![](figures/values1.png){class="filter-img"}
...
![](figures/values2.png){class="filter-img"}
...
![](figures/values3.png){class="filter-img"}
...
::: {.item}
![](figures/missions3.png){class="special"}
